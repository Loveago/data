...
type FulfillmentControl = {
  forcedProvider: "encart" | "grandapi" | "datahubnet" | "elitnut" | "skanka5" | null;
  activeProvider: "encart" | "grandapi" | "datahubnet" | "elitnut" | "skanka5";
  nowUtc: string;
  dayWindowUtc: {
    start: string;
    end: string;
...
export default function AdminDashboardPage() {
  ...
  const [providerInput, setProviderInput] = useState<"auto" | "encart" | "grandapi" | "datahubnet" | "elitnut" | "skanka5">("auto");
            ...
            <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center">
              <select
                ...
                onChange={(e) => {
                  ...
                  if (v === "encart" || v === "grandapi" || v === "datahubnet" || v === "elitnut" || v === "skanka5") setProviderInput(v);
              ...
              >
                ...
                <option value="skanka5">Force Skanka5</option>
              </select>
              <button
                type="button"
