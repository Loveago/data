      ...
      <div className="relative w-full max-w-5xl">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div className="hidden lg:block">
            <div className="inline-flex items-center gap-2 rounded-full bg-indigo-50 px-4 py-2 text-xs font-semibold text-indigo-700 ring-1 ring-indigo-100 dark:bg-indigo-950/30 dark:text-indigo-300 dark:ring-indigo-900/40">
              <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-white text-indigo-700 ring-1 ring-indigo-100 dark:bg-black/40 dark:text-indigo-300 dark:ring-indigo-900/40">
            ...
            <div className="mt-8 grid gap-3 text-sm text-slate-700 dark:text-zinc-200">
              <div className="flex items-center gap-3">
                <span className="inline-flex h-9 w-9 items-center justify-center rounded-2xl bg-white/80 text-indigo-700 ring-1 ring-slate-200 shadow-card dark:bg-slate-900/60 dark:text-indigo-300 dark:ring-slate-700">
              ...
              <div className="flex items-center gap-3">
                <span className="inline-flex h-9 w-9 items-center justify-center rounded-2xl bg-white/80 text-emerald-700 ring-1 ring-slate-200 shadow-card dark:bg-slate-900/60 dark:text-emerald-300 dark:ring-slate-700">
                  <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5" aria-hidden="true">
              ...
              <div className="flex items-center gap-3">
                <span className="inline-flex h-9 w-9 items-center justify-center rounded-2xl bg-white/80 text-violet-700 ring-1 ring-slate-200 shadow-card dark:bg-slate-900/60 dark:text-violet-300 dark:ring-slate-700">
                  <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5" aria-hidden="true">
              ...
              <div className="rounded-3xl border border-slate-200/70 bg-white/80 p-7 shadow-card backdrop-blur dark:border-slate-700/70 dark:bg-slate-900/70">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Welcome back. Let&apos;s get you signed in.</p>
                  </div>
                  <div className="hidden sm:flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-500 text-white shadow-sm">
                ...
                <div className="mt-7 space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/forgot-password" className="text-xs font-semibold text-indigo-700 hover:underline dark:text-indigo-300">
                        Forgot password?
                      </Link>
                    </div>
                    <input
